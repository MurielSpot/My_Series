...
def single_input(txt,max_seq_len,vocab_dict,ischar,hascls,hassep,stops=[]):
    ...
    split_tokens=vocab.tokenize(txt,ischar=ischar,stops=stops)
    tokens_ids=vocab.tokens_to_ids(split_tokens,vocab_dict,skip=True)
    # 添加cls和sep
    if hascls:
...
if __name__=="__main__":
    vocab_dict=vocab.vocab_ids(r"E:\code\judgement\code\bert\chinese_L-12_H-768_A-12\vocab.txt",start_ids=0)
