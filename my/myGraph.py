...
def draw_line(x,y,save_path=None,line_style="b-",img_name="line graph",x_name="x axis",y_name="y axis"):
    plt.title(img_name)
    plt.xlabel(x_name)
    plt.ylabel(y_name)
    plt.margins(0)
...
def draw_dot(x,y,save_path=None,dot_color="b",img_name="dot graph",x_name="x axis",y_name="y axis"):
    plt.title(img_name)
    plt.xlabel(x_name)
    plt.ylabel(y_name)
